...
//Place la position de départ en haut à gauche
CELLS[startPosition].classList.add("start");
matrixTable[0][0] = START;

//Place la position de fin en bas à droite
...
/**
 * Rajoute directement des event listener sur les cells créées par le JS + système de collision, on ne peut
 * pas placer un mur sur la position de départ par ex.
 */
...
/**
 * Fonction permettant de n'avoir qu'un bouton enfoncé à la fois car
 * styliser des radios buttons est plus dur (＃°Д°)
 */
